...
<div class="row"> 	
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            ...
            <ol>
            	<h3>Siswa yang baru lulus SMP atau Pindahan dari SMA lain dapat mencetak biaya pendaftaran yang harus dibayarkan</h3>
            </ol>    

            <h4><b>Biaya yang harus dibayarkan tegantung dari jenis kelasnya (A/B), kententuan sebagai berikut: </b></h4>
			<ol>
				<li><b>Biaya yang harus dibayar untuk mendaftarkan diri ke SMA Prakasa 3 Jakarta Barat : </b></li>
				<table class="table table-responsive table-hove">
					...
					<tbody>
						...
						<tr>
							...
							<td align="right"><b>Rp.9.335.000</b></td>
						</tr>
					</tbody>
				</table>
			</ol>
