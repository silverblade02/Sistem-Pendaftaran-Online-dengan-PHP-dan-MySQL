...
?>
<a href="index.php?page=23&kelas=A" class="btn btn-primary pull-right btn-md" style="margin-right: 80px"><i class="fa fa-plus"></i> Input jadwal Kelas 10</a>
<div class="row">
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            <div class="card-header" data-background-color="blue">
                <h4 class="title">Jadwal Kelas 10</h4>
                <p class="category">Daftar Mata Pelajaran Kelas 10</p>
...
<a href="index.php?page=23&kelas=B" class="btn btn-primary pull-right btn-md" style="margin-right: 80px"><i class="fa fa-plus"></i> Input jadwal Kelas 11</a>

<div class="row">
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            <div class="card-header" data-background-color="blue">
                <h4 class="title">Jadwal Kelas 11</h4>
                <p class="category">Daftar Mata Pelajaran Kelas 11</p>
            </div>
            <div class="card-content">
                <div class="row">
