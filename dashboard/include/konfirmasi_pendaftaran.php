    ...
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
            <div class="card-header" data-background-color="blue">
                <h4 class="title">Konfirmasi Pendaftaran Siswa/i baru SMA Prakasa 3 Jakarta Barat</h4>
                <p class="category">Lakukan konfirmasi pendaftaran agar siswa/i baru dapat melanjutkan tahap pembayaran</p>
            </div>
